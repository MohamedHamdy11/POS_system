        ...
        <section class="content-header">
          <h1>@lang('site.clients')</h1>
            ...
            <li><a href="{{route('dashboard.index')}}"><i class="fa fa-dashboard"></i>@lang('site.dashboard')</a></li>
                <li><a href="{{route('dashboard.categories.index')}}"><i class="fa fa-dashboard"></i>@lang('site.clients')</a></li>
                <li class="active"><a href="{{route('dashboard.clients.create')}}"><i class="fa fa-dashboard"></i>@lang('site.edit')</a></li>
            </ol>
        </section>
