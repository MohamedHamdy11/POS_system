                ...
                p = (function() {
                    function t() {
                        ...
                        return (
                            ...
                            (this.id = this.options.id || c.generateID("bar")),
                            (this.closeTimer = -1),
                            (this.barDom = null),
                            (this.layoutDom = null),
                                    ...
                                    value: function() {
                                        ...
                                        return (
                                            ...
                                            null === this.options.animation.open
                                                ? (this.promises.show = new u.default(
                                                      function(t) {
                                                          t();
                                                      }
                                                  ))
                                        ...
                                        return this.closed
                                            ...
                                            ? (d.fire(this, "onClose"),
                                              ...
                                              this.options.animation.close
                                                  ? (this.promises.close = new u.default(
                                                        function(t) {
                                                            t();
                                                        }
                                                    ))
