!(function(e) {
    ...
    function a(e) {
        ...
        if (
            ((e = "start" == e.toLowerCase() ? "Start" : "End"),
            document.selection)
        ) {
            var a,
                i,
